...
from src.settings.config import EnvDatabaseConfig, DatabaseManager

# Создаем экземпляр конфигурации базы данных
...
# Обновляем конфигурацию Alembic с URL подключения
...
# Добавляем метаданные моделей для поддержки автогенерации миграций
